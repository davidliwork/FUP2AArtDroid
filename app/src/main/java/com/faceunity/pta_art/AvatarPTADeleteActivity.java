...
import com.faceunity.pta_art.utils.FullScreenUtils;

import java.util.Arrays;
import java.util.List;

public class AvatarPTADeleteActivity extends AppCompatActivity implements View.OnClickListener {
    public static final String TAG = AvatarPTADeleteActivity.class.getSimpleName();
    ...
    public static void start(Activity context) {
        Intent intent = new Intent(context, AvatarPTADeleteActivity.class);
    ...
    public void onBackPressed() {
        startActivity(new Intent(AvatarPTADeleteActivity.this, MainActivity.class));
        super.onBackPressed();
    ...
    class AvatarP2ARecyclerAdapter extends RecyclerView.Adapter<AvatarP2ARecyclerAdapter.HomeRecyclerHolder> {
        ...
        public AvatarP2ARecyclerAdapter.HomeRecyclerHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            return new AvatarP2ARecyclerAdapter.HomeRecyclerHolder(LayoutInflater.from(AvatarPTADeleteActivity.this).inflate(R.layout.layout_delete_bottom_item, parent, false));
        }
