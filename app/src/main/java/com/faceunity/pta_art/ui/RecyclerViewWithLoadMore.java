...
import com.faceunity.pta_art.utils.LoadMoreAdapter;

/**
 * Created by jiangyongxing on 2020/4/2.
 * 描述：
 */
public class RecyclerViewWithLoadMore extends RecyclerView {
    ...
    private LoadMoreAdapter mFooterViewAdapter;
    ...
    public RecyclerViewWithLoadMore(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public RecyclerViewWithLoadMore(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context) {
        mFooterView = LayoutInflater.from(context).inflate(R.layout.layout_loading_view_footer_default, null);
...
//        setHasLoadMore(false);
    ...
    public void setAdapter(Adapter adapter) {
        ...
        mFooterViewAdapter = new LoadMoreAdapter(adapter, mFooterView);
     ...
     */
    public void setOnItemClickListener(LoadMoreAdapter.OnItemClickListener listener) {
